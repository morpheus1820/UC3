...
| People following and tracking | `ste93/convince_people_detector:ubuntu_24.04_jazzy` | https://github.com/hsp-iit/2d_lidar_people_tracker/blob/jazzy/docker/Dockerfile | `nvidia/cuda:12.8.1-devel-ubuntu24.04` | |
